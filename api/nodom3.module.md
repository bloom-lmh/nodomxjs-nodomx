...
|  --- | --- | --- |
|  [(constructor)(id)](./nodom3.module._constructor_.md) |  | 构造器 |

## Properties

|  Property | Modifiers | Type | Description |
|  --- | --- | --- | --- |
|  [children](./nodom3.module.children.md) |  | Array&lt;[Module](./nodom3.module.md)<!-- -->&gt; | 子模块数组，模板中引用的所有子模块 |
|  [cssRules](./nodom3.module.cssrules.md) |  | string\[\] | 模块引入的css rules 名数组 |
...
|  [excludedProps](./nodom3.module.excludedprops.md) |  | string\[\] | 不渲染的属性（这些属性用于生产模板，不作为属性渲染到模块根节点） |
...
|  [modules](./nodom3.module.modules.md) |  | unknown\[\] | 模板中引用的模块类集合 如果引用的模块类已通过registModule注册，这里不再声明 |
...
|  [slots](./nodom3.module.slots.md) |  | Map&lt;string, [RenderedDom](./nodom3.rendereddom.md)<!-- -->&gt; | <p>slot map</p><p>key: slot name</p><p>value: 渲染节点</p> |
...
|  [destroy()](./nodom3.module.destroy.md) |  | 销毁 |
|  [doModuleEvent(eventName)](./nodom3.module.domoduleevent.md) |  | 执行模块事件 |
|  [get(model, key)](./nodom3.module.get.md) |  | 获取模型属性值 |
|  [getModule(name, attrs, deep)](./nodom3.module.getmodule.md) |  | 按模块类名获取子模块 |
|  [getModules(className, attrs, deep)](./nodom3.module.getmodules.md) |  | 获取模块类名对应的所有子模块 |
|  [getNode(params)](./nodom3.module.getnode.md) |  | 根据条件获取html节点 |
|  [getParent()](./nodom3.module.getparent.md) |  | 获取父模块 |
|  [getRenderedDom(params)](./nodom3.module.getrendereddom.md) |  | 根据条件获取渲染节点 |
|  [init()](./nodom3.module.init.md) |  | 初始化操作 |
|  [invokeMethod(methodName, args)](./nodom3.module.invokemethod.md) |  | 调用模块方法 |
...
|  [unmount(passive)](./nodom3.module.unmount.md) |  | 从document移除 |
|  [watch(model, key, func)](./nodom3.module.watch.md) |  | 监听model |

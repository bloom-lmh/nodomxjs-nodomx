...
import { RenderedDom, RouteGuard, RouteLocation } from "@nodomx/shared";
...
export declare class Router {
    ...
    preload(path: string): Promise<RouteLocation>;
    ...
    private ensureRouteComponentLoaded;
    private preloadMatchedRoutes;
    private shouldPreloadRoute;

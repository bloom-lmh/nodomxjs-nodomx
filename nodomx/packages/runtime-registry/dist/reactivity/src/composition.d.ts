...
type BindingNotifier = (model: object, key: TrackKey, oldValue: unknown, newValue: unknown) => void;
export interface CompositionScope {
    addCompositionCleanup(cleanup: () => void): void;
}
export declare function configureReactivityRuntime(options?: {
...
export declare function withCurrentScope<TScope extends CompositionScope, T>(scope: TScope, handler: () => T): T;
export declare function getCurrentScope<TScope extends CompositionScope = CompositionScope>(): TScope | undefined;

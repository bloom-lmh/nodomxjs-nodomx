...
```bash
node ./create-nodomx/bin/create-nodomx.mjs my-app --package-mode local --install
```
...
- `../nd-compiler`: `.nd` parser, compiler, CLI and watch utilities
- `../rollup-plugin-nd`: Rollup plugin for direct `.nd` imports
- `../rollup-plugin-dev-server`: Rollup-based development server with live reload
- `../create-nodomx`: starter scaffold generator
- `../vscode-extension`: local VSCode extension and language server
